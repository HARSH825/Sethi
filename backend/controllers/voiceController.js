// backend/controllers/voiceController.js (COMPLETE AFTER PHASE 1)
import voiceService from '../services/voiceService.js';
import llmService from '../services/llmService.js';

class VoiceController {
  /**
   * Process voice input during onboarding (WORKING PERFECTLY)
   */
  async processOnboarding(req, res) {
    try {
      ...
      // Step 6: CRITICAL - Emit via WebSocket
  ...
  /**
   * NEW: Process scheme-specific voice commands (PHASE 1 ENHANCEMENT)
   */
